...
>
  {['/lohamandi1.png', '/lohamandi2.png', '/lohamandi3.png'].map((img, i) => (
    <SwiperSlide key={i}>
      <div
        className="w-full min-h-[80vh] bg-cover bg-center flex justify-center"
        style={{ backgroundImage: `url('${img}')` }}
      >
        <div className="w-[100vw] min-h-[80vh] bg-black/50 flex flex-col md:flex-row items-center justify-between px-4 md:px-10 text-white">
          {/* Left Content */}
          <div className="flex flex-col justify-center items-start gap-6 py-10 md:py-0 w-full md:w-1/2">
          ...
          {/* Right Form Card */}
          <div className="hidden md:flex justify-center items-center w-full md:w-1/2 py-10">
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-sm text-black space-y-6">
              ...
              <form className="flex flex-col gap-4">
                ...
                <button className="flex items-center justify-center gap-2 bg-[#25D366] text-white py-4 px-6 rounded-lg hover:bg-green-600 transition">
                  <a href="https://wa.me/919910025184" target="_blank" rel="noopener noreferrer">
        ...
        {/* ===== Mobile Hero Content Over Swiper Background ===== */}
        ...
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-300 shadow-xl">
          ...
          <div className="flex justify-between px-3 pb-3 gap-2">
            <button className="flex items-center justify-center gap-1 bg-[#0AC1F5] text-white text-sm font-semibold px-3 py-2 rounded-md w-1/2">
              <FaPhoneAlt className="text-lg" /> Call
            </button>
            <button className="flex items-center justify-center gap-1 bg-[#25D366] text-white text-sm font-semibold px-3 py-2 rounded-md w-1/2">
