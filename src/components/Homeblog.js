    ...
    <div className="bg-[#E7F0DD] min-h-screen py-12 px-4 sm:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6 text-center md:text-left">
          <h2 className="text-[#A01F16] text-xl sm:text-2xl font-semibold">About Lohamandi</h2>
          ...
          <p className="text-gray-700 text-base sm:text-lg md:text-xl">
            ...
            From TMT Bars to structural steel, we ensure quality, custom sizing and doorstep delivery — all with just a few clicks.
          </p>
          <button className="bg-[#E7F0DD] text-black font-semibold px-6 py-3 sm:py-4 rounded-md hover:opacity-90 
