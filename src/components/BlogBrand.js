  ...
  return (
    <section className="bg-gradient-to-b from-white to-[#FFF3F3] min-h-[60vh] py-12 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto text-center space-y-6">
        ...
        {/* Brand Logos */}
        <div className="grid grid-cols-2 sm:grid-cols-8 gap-2 items-center justify-center mt-10">
          <img src="/logo5.png" alt="Moira" className="h-20 object-contain mx-auto" />
          <img src="/logo2.png" alt="Mahaan" className="h-20 object-contain mx-auto" />
          <img src="/logo3.png" alt="Jindal" className="h-20 object-contain mx-auto" />
          <img src="/logo4.png" alt="Mongia" className="h-20 object-contain mx-auto" />
