      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="text-sm text-gray-300 space-y-4 border-b border-gray-700 pb-6">
          ...
          <div>
            ...
            MS Rounds | MS Angles | MS Equal Angles | MS Squares | MS Channels | C Channels | U Channels | HR Sheets | CR Sheets | MS Plates | MS Flats | Joist (ISMB) | Narrow Parallel Flange Beams | Wide Parallel Flange Beams | Universal Beams (UB) | Universal Columns (UC) | MS Rectangular Pipes | Light Pipes | Medium Pipes | Heavy Pipes | MS Square Pipes
          </div>
          <div>
            <span className="font-semibold text-white">SPECIAL STEEL</span>:&nbsp;
            EN Flats | EN Plates | EN Rounds | HR Plates | GP Sheets | Seamless Round Pipes | Round Rods | GP Square Pipes | GP Rectangular Pipes | GP Round Pipes | Roofing Sheets
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
          ...
          <div className="w-full lg:w-[30%] space-y-3">
            <img src="/logo.png" alt="Lohamandi Logo" className="h-10" />
            <p className="text-sm font-semibold">Lohamandi Services Pvt. Ltd.</p>
            <p className="text-sm text-gray-400">India’s trusted online steel marketplace</p>
            <p className="text-sm font-semibold mt-3">Registered Office</p>
            <p className="text-sm text-gray-400">
              4th Floor, Metro Plaza,<br />
              New Delhi - 110001
            </p>
            <p className="text-sm text-gray-400">
              CIN: U12345DL2020PTC123456<br />
      ...
      <FaYoutube />
        ...
        <div className="border-t border-gray-700 py-6">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Lohamandi is India’s leading online steel marketplace, breaking the traditional barriers of buying and selling steel. It connects manufacturers, suppliers, and buyers across a unified platform.
            We simplify the procurement process by offering competitive pricing, verified suppliers, and secure delivery—making steel sourcing more efficient and reliable.
            Lohamandi also empowers local sellers to become verified suppliers after meeting strict product quality standards.
          </p>
        </div>
      </div>
    </footer>
